...
const SignUpPage = () => {
  ...
  return (
    <div className="w-full bg-fuchsia-200 flex items-center justify-center min-h-screen p-4">
            ...
            <div className=" md:w-1/2 p-8 md:border-r border-fuchsia-300 flex items-center justify-center">
              <div className="w-full max-w-md">
                ...
                <p className="text-center mt-4 text-fuchsia-400 text-sm">
                  ...
                  <span
                    className="text-fuchsia-900 cursor-pointer hover:text-fuchsia-500"
            ...
            <div className="md:w-1/2 md:p-8 pt-0 pb-8  items-center justify-center">
              <div>
                ...
                <p className="text-fuchsia-400 text-sm italic px-5 text-center">
                  Share thoughts, memories, and emotions in a safe place made
                  just for you. Create an account and start sending messages
                  that truly matter.
                </p>
